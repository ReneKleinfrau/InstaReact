Module XPaths
    ...
    Public FollowButton_1_XPath As String = "/html/body/div[1]/div/div/div/div[1]/div/div/div/div[1]/section/main/div[1]/div[1]/article/div/div[2]/div/div[1]/div/header/div[2]/div[1]/div[2]/button" 'Button Class above: <button class="_acan _acao _acas" type="button"><div class="_ab8w  _ab94 _ab99 _ab9h
    ...
    Public LikeButton_1_XPath As String = "/html/body/div[1]/div/div/div/div[1]/div/div/div/div[1]/section/main/div[1]/div[1]/article/div/div[2]/div/div[2]/section[1]/span[1]/button" 'Button direct: <button class="_abl-" type="button"><div class="_abm0 _abm1"
    ...
    Public Notify_XPath As String = "/html/body/div[1]/div/div/div/div[2]/div/div/div[1]/div/div[2]/div/div/div/div/div[2]/div/div/div[3]/button[2]"
End Module
